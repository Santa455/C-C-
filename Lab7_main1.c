...
// **/
//volatile bool INTCCR0 = FALSE;
//volatile bool INTCCR2 = FALSE;
////volatile bool OUTPUT = 1;
////volatile bool OUT = 1;
//
...
//   INTCCR0 = TRUE; //Interrupt occurred
...
//    while(1){
//      if (INTCCR2){
//       P2OUT &= 0x04; //  set low establishing a high time of 2 ms
//        INTCCR2 = FALSE;
//      }
